...
export const INITIAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    "description": "At Antaara Design Studio every project is a story, every space is an emotion, and every detail reflects timeless craftsmanship.\n\nA bespoke residence designed at Omaxe, Mathura, representing a rare legacy of trust and creative kinship with Hema Malini Ji, featuring dedicated artistic commissions and tributes celebrating legacy, memory and interior stillness.",
    "page": 4,
  ...
  },
  {
    ...
    "scope": "Immersive Acoustic Interior Design, LED Lighting & Custom Bar Design",
    "year": "2024",
    "featured": true,
    "order": 6,
  ...
  },
  {
    ...
    "category": "Commercial",
    "subtitle": "Elevated Customer Journey & Interior Experience Design",
    ...
    "featured": false,
    "order": 15,
    "summary": "A fully designed automotive dealership and customer experience touchpoint reflecting brand excellence, sophistication, and seamless interior flow.",
  ...
  },
  {
    ...
    "client": "Private Family",
    "scope": "Penthouse-Level 4 BHK Interior Design & Panoramic Balcony Experience",
    "year": "2024",
    "featured": true,
    "order": 16,
