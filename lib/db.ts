...
export async function getSettings(): Promise<Record<string, any>> {
  const defaultSettings = {
    ...
    founderTitle: "Founder & Principal Interior Designer",
    tagline: "Spaces That Tell A Story",
    founderPositioning:
      "Antaara Design Studio is a premium interior design firm led by Kirti Jaiswal Rajpal, with 15 years of experience and 50+ completed projects across India.",
